            ...
            <tbody>
                <?php foreach ($this->rows as $row) { ?>
                    <tr>
                        ...
                        <?php } ?>
                        <td>
                            <a href="<?php echo constant("URL") ?>/chofer/edit?id=<?php echo ($row[5]) ?>" class="btn btn-secondary">Editar</a>
                            <a href="<?php echo constant("URL") ?>/chofer/delete?id=<?php echo ($row[5]) ?>" class="btn btn-danger">Eliminar</a>
                        </td>
                    </tr>
                <?php } ?>
